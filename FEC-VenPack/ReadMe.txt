Doc ID:  ReadMe.txt						   Date:  02/07/2014
...
for it to meet the proper filing format (Refer to FEC_Format_v8.1.pdf and 
FEC_Format_v8.1.xlsx) necessary for filing a report electronically with the 
...
Programs and any accompanying run-time libraries and files may 
...
Acknowledgement of FEC software copyright does not need to be included within
Third Party software, however FEC does maintain copyrights to the following
...
Root directories:
-----------------
   FECCheck (Version 8.1.0.1)
   FECLoad  (Version 8.1)
   FECPrint (Version 8.1.0.1)


ReadMe.txt           This file lists the contents of VendPak.zip.  

FEC_Format_v8.1.pdf  Adobe document - describes FEC specifications for 
                     electronic filing.  

FEC_Format_v8.1.xlsx  MS Excel spreadsheet - Contains detailed formats for
                     each type of record used in electronic filings.  


FECCheck (directory contains v8.1.0.1 FECCheck JAVA Validator files)
...
FECload (directory contains v8.1 FECload JAVA files)
...
FECPrint (directory contains v8.1.0.1 FECPrint JAVA files)
